-- -----------------------------------------------------
-- Schema zaplanujjedzonko
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `zaplanujjedzonko` DEFAULT CHARACTER SET utf8 ;
USE `zaplanujjedzonko` ;

-- -----------------------------------------------------
-- Table `zaplanujjedzonko`.`admins`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zaplanujjedzonko`.`admins` (
...
-- -----------------------------------------------------
-- Table `zaplanujjedzonko`.`recipe`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zaplanujjedzonko`.`recipe` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli.',
  ...
  CONSTRAINT `fk_recipie_admins1`
    ...
    REFERENCES `zaplanujjedzonko`.`admins` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `zaplanujjedzonko`.`plan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zaplanujjedzonko`.`plan` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli',
...
-- -----------------------------------------------------
-- Table `zaplanujjedzonko`.`day_name`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zaplanujjedzonko`.`day_name` (
...
-- -----------------------------------------------------
-- Table `zaplanujjedzonko`.`recipe_plan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zaplanujjedzonko`.`recipe_plan` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli.',
  ...
  CONSTRAINT `fk_recipe_plan_recipe1`
    ...
    REFERENCES `zaplanujjedzonko`.`recipe` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_recipe_day_day_name1`
    FOREIGN KEY (`day_name_id`)
    REFERENCES `zaplanujjedzonko`.`day_name` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_recipe_plan_plan1`
    FOREIGN KEY (`plan_id`)
    REFERENCES `zaplanujjedzonko`.`plan` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Zabela zawierająca informacje o połączeniu przepisu oraz planu.';


-- -----------------------------------------------------
-- Table `zaplanujjedzonko`.`pages`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zaplanujjedzonko`.`pages` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT 'Klucz główny tabeli',
